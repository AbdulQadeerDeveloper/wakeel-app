...
const featureSection = [
  {
    ...
    detail:
      "Your privacy is our priority. With end-to-end encryption,you can be sure that your personal messages stay between you and your lawyer, to ensure the privacy and securiy of the communication.",
    img: messageImage,
  },
  {
    title: "Easy",
...
export { SecondaryNavbar, PrimaryNavbar, ServicesData, FooterLink, OnlineDealingsData, connectWithUs, featureSection };
