  ...
  return (
    <>
      <div className="row">
        ...
        <p className="para">
          Empowering Your Legal Journey at our app, our mission is simple to empower individuals with reliable legal advice and support. We believe in demystifying the complexities of the law, making
          it accessible to everyone, anytime, and anywhere.
        </p>
      </div>
