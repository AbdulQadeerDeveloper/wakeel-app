...
const featureSection: FeatureData[] = [
  {
    ...
    detail: "Your privacy is our priority. With end-to-end encryption, we ensure that your personal messages stay between you and your lawyer, to ensure the privacy.",
  ...
  },
  {
    ...
    title: "Easy",
    greenTitle: "To Hire",
    detail: "Hiring a lawyer through Wakeel is simple and efficient. You can begin by providing essential details about your legal situation within a few clicks. Our intuitive case evaluation feature helps match you with lawyers who have expertise in handling cases similar to yours.",
    img: "/api/placeholder/600/400"
  },
  {
    id: 3,
    title: "Find",
    greenTitle: "The Best Lawyer",
...
const Feature: React.FC = () => {
  return (
    <section id="features" className="relative py-12 lg:py-16 bg-gray-50 overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="relative max-w-5xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="text-center mb-12 lg:mb-16">
          <div className="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium tracking-wide uppercase mb-4" 
               style={{ 
          ...
          <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-800 mb-4">
            Features for
            <span className="bg-gradient-to-r from-[rgba(22,99,58,1)] to-[rgba(3,75,36,1)] bg-clip-text text-transparent"> Legal Success</span>
          </h2>
              ...
              <div className={`space-y-4 ${index % 2 === 1 ? 'lg:col-start-2' : ''}`}>
                ...
                <div className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium"
                  ...
                  <div className="w-2 h-2 rounded-full mr-2 animate-pulse"
                       style={{ backgroundColor: 'rgba(255, 181, 57, 1)' }}></div>
      ...
      {` ${feature.greenTitle}`}
                ...
                <div className="flex flex-wrap gap-2 pt-2">
                  ...
                  <div className="flex items-center space-x-2 bg-yellow-50 px-3 py-1 rounded-full">
                    ...
                    <span className="text-xs font-medium text-yellow-600">Fast</span>
                  </div>
                  <div className="flex items-center space-x-2 bg-blue-50 px-3 py-1 rounded-full">
                    <Sparkles className="w-3 h-3 text-blue-500" />
                    <span className="text-xs font-medium text-blue-500">Reliable</span>
                  </div>
                </div>

                {/* CTA Button */}
                <div className="pt-4">
                  <button className="group inline-flex items-center px-5 py-2.5 
...
>
                  ...
                  <div className="absolute -bottom-4 -left-4 bg-white rounded-xl p-3 shadow-lg border border-gray-100 transform group-hover:scale-105 transition-transform duration-300">
                    <div className="text-center">
                      <div className={`text-lg font-bold ${index % 2 === 0 ? 'text-green-600' : 'text-yellow-600'}`}>
                        99%
                      </div>
